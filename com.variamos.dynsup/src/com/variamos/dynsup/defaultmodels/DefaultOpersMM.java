	...
	public static void createOpersMetaModel(ModelInstance refas, boolean empty) {
		...
		if (!empty) {
			...
			instOperSubOperationExpType.addInstAttribute("suboperexptype",
					metaExpType.getAbstractAttribute("suboperexptype", null,
							null), "NORMAL");
		...
		if (!empty) {
			...
			attribute = new ElemAttribute("ConcernLevel", "Class",
					AttributeType.OPERATION, false, "Concern Level",
					InstConcept.class.getCanonicalName(), "CG", null, "", 2,
					-1, "", "", -1, "", "");
			...
			attribute = new ElemAttribute("satisficingLevel", "String",
					AttributeType.OPERATION, "Satisficing Level", "low", false,
					d, 0, 10, "", "", -1, "", "");
			...
			attribute = new ElemAttribute("SDReqLevel", "Integer",
					AttributeType.EXECCURRENTSTATE, false,
					"Required Level by SD", 0, new RangeDomain(0, 4), 2, -1,
					"", "", -1, "", "");
			...
			t1 = new OpersExpr("1", refas.getSemanticExpressionTypes().get(
					"Subtraction"),
					ExpressionVertexType.LEFTUNIQUEOUTCONVARIABLE,
					instDirHardHardSemanticEdge, instVertexHC, null, "Sel",
					false, 1);
			...
			t1 = new OpersExpr("1", refas.getSemanticExpressionTypes().get(
					...
					instDirFeatFeatSideSemEdge, null, instVertexF, "Sel",
					false, 1);
			...
			ias.add(new InstAttribute("implementation", new ElemAttribute(
					...
					AttributeType.OPTION, false, "implementation", "", 1, -1,
					"", "", -1, "", ""),
			...
			t1 = new OpersExpr("1", refas.getSemanticExpressionTypes().get(
					"Subtraction"),
					ExpressionVertexType.LEFTUNIQUEOUTCONVARIABLE,
					instDirSGSGSemanticEdge, instVertexSG, null, "Sel", false,
					1);
			...
			attribute = new ElemAttribute("level", "Integer",
					AttributeType.OPERATION, "Level", 0, false,
					new RangeDomain(0, 5), 0, -1, "", "", -1, "", "");
