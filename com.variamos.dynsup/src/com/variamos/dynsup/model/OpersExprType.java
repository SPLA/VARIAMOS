...
public class OpersExprType implements Serializable {
	...
	public static List<OpersExprType> getValidSemanticExpressionTypes(
			Collection<OpersExprType> semanticExpressionList, int valid) {
		List<OpersExprType> out = new ArrayList<OpersExprType>();
		for (OpersExprType semanticExpressionType : semanticExpressionList) {
