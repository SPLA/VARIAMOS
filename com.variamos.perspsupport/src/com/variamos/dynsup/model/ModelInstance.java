...
import com.variamos.dynsup.defaultmodels.RefasDefaultOpers;
import com.variamos.dynsup.defaultmodels.RefasDefaultSyntax;
...
public class ModelInstance extends AbstractModel {
	...
	public com.variamos.dynsup.instance.InstElement getElement(
			String vertexId) {
	...
	public void removeElement(InstElement obj) {
		...
		if (obj instanceof InstOverTwoRel) {
			...
			constraintInstEdges.remove(((InstPairwiseRel) obj)
					.getIdentifier());
	}
	...
	private void createOperationsInfrastructure() {
		...
		SyntaxPairwiseRel basicOpersSyntaxM3ExtendsRelation = new SyntaxPairwiseRel(
				"ExtendsRelation",
				false,
				true,
				"Extends Relation",
		...
		basicOpersM2SemModel.putSemanticAttribute("name",
				new OpersAttribute("name", "String",
		...
		basicOpebrsM2OperGroup.putSemanticAttribute("menuType",
				new OpersAttribute("menuType", "Integer",
		...
		basicOpebrsM2OperGroup.putSemanticAttribute("visible",
				new OpersAttribute("visible", "Boolean",
		...
		basicOpebrsM2OperGroup.putSemanticAttribute("shortcut",
				new OpersAttribute("shortcut", "String",
		...
		basicOpebrsM2OperGroup.putSemanticAttribute("Index",
				new OpersAttribute("Index", "Integer",
	...
	private void createSyntaxInfrastructure() {
		...
		SyntaxConcept infraSyntaxM2Concept = new SyntaxConcept('C', "SMMConcept",
		...
		SyntaxConcept infraSyntaxM2View = new SyntaxConcept('V', "SMMView", true,
		...
		InstPairwiseRel instViewRelation = new InstPairwiseRel(
	...
	public void createOperationsSuperstructure() {
		RefasDefaultOpers.createDefaultOperations(this);
	}
	...
	private Map<String, SyntaxElement> getValidPairwiseRelations(
		...
		for (InstPairwiseRel pwr : constraintInstEdges.values()) {
			if (pwr.getSourceRelations().size() > 0
				...
				SyntaxElement sourceMetaElement = pwr.getSourceRelations().get(0)
						.getEditableMetaElement();
				SyntaxElement targetMetaElement = pwr.getTargetRelations().get(0)
						.getEditableMetaElement();
