...
public abstract class InstVertex extends InstElement {
	...
	private SyntaxVertex supportMetaElement;
	 ...
	 * @return
	 */
	public SyntaxVertex getTransSupportMetaElement() {
	...
	public void setTransSupportMetaElement(SyntaxElement supportMetaElement) {
		...
		this.supportMetaElement = (SyntaxVertex) supportMetaElement;
	}

	public void setIdentifier(String identifier) {
		if (getDynamicVariable(SyntaxConcept.VAR_USERIDENTIFIER).equals("")) {
