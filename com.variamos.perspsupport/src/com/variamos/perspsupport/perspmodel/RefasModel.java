...
public class RefasModel extends AbstractModel {
	...
	public void createDefaultSemantic() {
		...
		variabilityInstVertex.put("SimulationGroup", instOperationGroup);
		...
		InstVertex instOperationSubAction = new InstConcept(
				...
				operationSubAction);
		variabilityInstVertex.put("Sim-Pre-Validation", instOperationSubAction);
		...
		variabilityInstVertex
				.put("Sim-Post-Validation", instOperationSubAction);

		instEdgeOper = new InstPairwiseRelation();
		this.constraintInstEdges.put("sim-pos-val", instEdgeOper);
		...
		instOperationGroup = new InstConcept("SimulationSceGroup",
				metaOperationMenu, operationMenu);
		variabilityInstVertex.put("SimulationSceGroup", instOperationGroup);
		...
		instOperationSubAction = new InstConcept("SimSce-Pre-Validation",
				metaOperationSubAction, operationSubAction);
		variabilityInstVertex.put("SimSce-Pre-Validation",
		...
		instOperationSubAction = new InstConcept("SimSce-Post-Validation",
				metaOperationSubAction, operationSubAction);
		variabilityInstVertex.put("SimSce-Post-Validation",
				instOperationSubAction);
		...
		instOperationGroup = new InstConcept("Verification", metaOperationMenu,
				operationMenu);
		variabilityInstVertex.put("Verification", instOperationGroup);
		...
		instOperationGroup = new InstConcept("Configuration",
				metaOperationMenu, operationMenu);
		variabilityInstVertex.put("Configuration", instOperationGroup);
		...
		attribute = new SemanticAttribute("satisficingLevel", "String",
				"Satisficing Level", "low", false, d, 0, 10, "", "", -1, "", "");
		...
		attribute = new SemanticAttribute(
				SoftSemanticConcept.VAR_SATISFICINGTYPE, "Enumeration", false,
		...
		t1 = new SemanticExpression("1", this.getSemanticExpressionTypes().get(
				...
				ExpressionVertexType.RIGHTUNIQUEOUTRELVARIABLE, instVertexOper,
				instVertexCL, "Selected", "CompExp");

		t1 = new SemanticExpression("OPERCLSelected", this
				.getSemanticExpressionTypes().get("DoubleImplies"),
				ExpressionVertexType.LEFTUNIQUEOUTRELVARIABLE, instVertexCL,
				"Selected", true, t1);
		...
		// this.getSemanticExpressionTypes().get(
		...
		attribute = new SemanticAttribute("ConfidenceLevel", "Integer",
				"Confidence Level", 1, false, new RangeDomain(1, 5), 0, -1, "",
				"", -1, "", "");
		...
		t2 = new SemanticExpression("1", this.getSemanticExpressionTypes().get(
				...
				instVertexHHGR, instVertexHC, instHchcHHGRGR, "Selected",
				"True", true);
		...
		t2 = new SemanticExpression("1", this.getSemanticExpressionTypes().get(
				...
				instVertexHHGR, instVertexHC, null, "Selected", "True", true); // FIX
		...
		t2 = new SemanticExpression("1", this.getSemanticExpressionTypes().get(
				"Sum"), ExpressionVertexType.LEFTITERINCCONVARIABLE,
				instVertexHHGR, instVertexHC, null, "Selected", true, 0); // FIX
																			// use
																			// instVertexHC
																			// after
																			// fixing
		...
		t1 = new SemanticExpression("ALTSelected", this
				...
				ExpressionVertexType.LEFTUNIQUEINCRELVARIABLE, instVertexHC,
				"Selected", true, t1);
		...
		t3 = new SemanticExpression("1", this.getSemanticExpressionTypes().get(
				"Equals"), ExpressionVertexType.LEFTUNIQUEINCRELVARIABLE,
				instVertexSG, instDirSGSGSemanticEdge, "satisficingLevel",
				"low");
		...
		t1 = new SemanticExpression("2", this.getSemanticExpressionTypes().get(
				"Sum"), ExpressionVertexType.LEFTUNIQUEINCRELVARIABLE,
				ExpressionVertexType.RIGHTUNIQUEOUTRELVARIABLE, instVertexSG,
		...
		t1 = new SemanticExpression("1", this.getSemanticExpressionTypes().get(
				"Equals"), ExpressionVertexType.LEFTUNIQUEOUTRELVARIABLE,
				instVertexSG, instDirSGSGSemanticEdge, null, "Selected", true,
				1);

		t1 = new SemanticExpression("ALTSelected", this
				.getSemanticExpressionTypes().get("Implies"),
				ExpressionVertexType.LEFTUNIQUEINCRELVARIABLE, instVertexSG,
				"Selected", true, t1);
		...
		t1 = new SemanticExpression("1", this.getSemanticExpressionTypes().get(
				"And"), ExpressionVertexType.LEFTUNIQUEINCRELVARIABLE,
				ExpressionVertexType.RIGHTUNIQUEOUTRELVARIABLE, instVertexSG,
				instDirSGSGSemanticEdge, "Selected", "Selected");
		...
		t1 = new SemanticExpression("1", this.getSemanticExpressionTypes().get(
				"Subtraction"), ExpressionVertexType.LEFTUNIQUEOUTRELVARIABLE,
				instVertexSG, instDirSGSGSemanticEdge, null, "Selected", false,
				1);
		...
		t1 = new SemanticExpression("1", this.getSemanticExpressionTypes().get(
				"And"), ExpressionVertexType.LEFTUNIQUEINCRELVARIABLE,
				ExpressionVertexType.RIGHTUNIQUEOUTRELVARIABLE, instVertexCLGR,
				instVertexCL, "Selected", "CompExp");
		...
		t1 = new SemanticExpression("1", this.getSemanticExpressionTypes().get(
				"And"), ExpressionVertexType.LEFTUNIQUEINCRELVARIABLE,
				ExpressionVertexType.RIGHTUNIQUEOUTRELVARIABLE,
				instVertexLFCLGR, instVertexCL, "Selected", "CompExp");
		...
		attribute = new SemanticAttribute(SemanticPairwiseRelation.VAR_LEVEL,
				"Integer", SemanticPairwiseRelation.VAR_LEVEL, 2, false,
				new RangeDomain(0, 5), 0, -1, "", "", -1, "", "");
		...
		attribute = new SemanticAttribute(SemanticPairwiseRelation.VAR_LEVEL,
				"Integer", SemanticPairwiseRelation.VAR_LEVELNAME, 0, false,
				new RangeDomain(0, 5), 0, -1, "", "", -1, "", "");
