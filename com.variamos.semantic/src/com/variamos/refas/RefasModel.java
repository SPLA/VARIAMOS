...
public class RefasModel extends AbstractModel {
	...
	public com.variamos.syntax.instancesupport.InstElement getElement(
			String vertexId) {
	...
	private void createBasicSemantic() {
		...
		semPairwExtRelList.add(new SemanticRelationType("association",
		...
		semConcept.addDirectRelation(semPairwExtRel);
		...
		rel.setSupportMetaPairwiseRelation(metaPairwiseRelExtends);
		...
		rel.setSupportMetaPairwiseRelation(metaPairwiseRelAso);
		rel.setTargetRelation(instConcept, true);
		rel.setSourceRelation(instConcept, true);
	...
	public void createSemantic() {
		 ...
		 * SemanticPairwiseRelation.VAR_LEVEL, new SemanticAttribute(
		 * SemanticPairwiseRelation.VAR_LEVEL, "Enumeration", false,
		 * SemanticPairwiseRelation.VAR_LEVEL,
		 * SemanticPairwiseRelation.VAR_LEVELCLASS, "plus plus", ""));
