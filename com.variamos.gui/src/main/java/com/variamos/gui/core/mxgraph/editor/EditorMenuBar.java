...
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.BackgroundImageAction;
...
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.ImportAction;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.PageBackgroundAction;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.PrintAction;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.SelectSpanningTreeAction;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.StyleAction;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.ToggleCreateTargetItem;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.ToggleGridItem;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.ToggleRulersItem;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.WarningAction;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.ZoomPolicyAction;
...
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.BackgroundAction;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.GridColorAction;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.GridStyleAction;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.KeyValueAction;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.PageSetupAction;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.PromptPropertyAction;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.PromptValueAction;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.ScaleAction;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.SelectShortestPathAction;
...
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.StylesheetAction;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.ToggleAction;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.ToggleConnectModeAction;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.ToggleDirtyAction;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.ToggleOutlineItem;
import com.variamos.gui.core.mxgraph.editor.EditorActionsController.TogglePropertyItem;
...
public class EditorMenuBar extends JMenuBar {
	...
	public EditorMenuBar(final BasicGraphEditor editor) {
		...
		// "/com/variamos/gui/perspeditor/images/saveas.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("pageSetup"),
				new PageSetupAction(),
				"/com/variamos/gui/perspeditor/images/pagesetup.gif"));
		...
		menu.add(editor.bind("Floy-Roy-Warshall", new AnalyzeGraph(
	...
	public static void populateFormatMenu(JMenu menu, BasicGraphEditor editor) {
		...
		submenu.add(editor.bind(mxResources.get("arrow"), new SetStyleAction(
				"arrow"), "/com/variamos/gui/perspeditor/images/arrow.gif"));
