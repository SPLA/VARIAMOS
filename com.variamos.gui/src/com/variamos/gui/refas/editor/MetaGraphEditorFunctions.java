 ...
 * perspective. Not implemented jet. Part of PhD work at University of Paris 1
 * 
 * @author Juan C. Muñoz Fernández <jcmunoz@gmail.com>
 * 
 * @version 1.1
 * @since 2014-11-17
 * @see com.variamos.gui.maineditor.AbstractGraphEditorFunctions
 */
			...
			for (int i = 0; i < paletteElements.size(); i++)
				try {
					...
					if (validElements.contains(paletteElement.getId())) {
						String classSingleName = paletteElement.getClassName()
								.substring(
