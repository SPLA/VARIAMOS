...
/**
 * @author unknown
 * jcmunoz: commented unused methods
 *
 */
...
/*	public void solve(int numSol, ConfigurationOptions options){
		...
		configurator.solve(config, options);
		int i = 0;
...
/*
	private void disableInvalid() {
		boolean used= configurator.validateInvalid();
...
//	}
	...
	*/
	...
	public void reduceDomain(){
		Configuration config = getCurrentConfiguration();
		//config.debugPrint();
		Map<String, List<Integer>> values = configurator.reduceDomain(config, getCurrentOptions());
	...
	public ConfigurationDTO getConfigurationDTO() {
		return configurator.getConfigurationDTO(getCurrentConfiguration(), getCurrentOptions());		
	}
