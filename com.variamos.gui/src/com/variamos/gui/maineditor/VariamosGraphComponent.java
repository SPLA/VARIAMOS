...
public class VariamosGraphComponent extends mxGraphComponent {
	...
	public void drawCellIcons(Object cell) {
		...
		tmp2 = model.getChildAt(tmp2, 0); //TODO implement for other model views
		...
		for (int i = 0; i < childCount; i++) {
			...
			if (tmp.getGeometry() != null && val != null
				...
				} else if (!(boolean) instConcept.getInstAttribute("Allowed")
						.getValue()) {
				...
				if ((boolean) instConcept.getInstAttribute("ForcedSatisfied")
						.getValue()) {
				...
				if ((boolean) instConcept.getInstAttribute("ForcedSelected")
						.getValue()) {
					mxCellOverlay over3 = new mxCellOverlay(new ImageIcon(
							mxGraphComponent.class.getResource(forced)),
				...
				if ((boolean) instConcept
						.getInstAttribute("ValidationSelected").getValue()) {
					mxCellOverlay over3 = new mxCellOverlay(new ImageIcon(
