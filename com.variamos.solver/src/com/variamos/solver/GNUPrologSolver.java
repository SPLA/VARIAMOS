...
public class GNUPrologSolver implements Solver {
	...
	public boolean hasNextSolution() {
		return false;// qr.hasMoreSolutions();
	}
	...
	// private PrologTransformParameters getParamsFor(ConfigurationOptions
	// options) {
	...
	// }
	//
	// private PrologTransformParameters addParametersToProgram(HlclProgram
	// prog,
