...
public class ProductLine {
	...
	public void printDebug(PrintStream out) {
		System.out.println("#============= VariabilityElements : "
				+ getVariabilityElements().size() + " =============");
	...
	public void addConstraint(Constraint c) {
		...
		/*
		 * } else{ int j = Integer.parseInt(id); while(
		 * constraints.containsKey("cons" + j) ){ j++; } id="cons" + j;
		 * System.out.println(id); constraints.put(id, c); }
		 */
