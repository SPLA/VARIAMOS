...
import com.variamos.hlcl.model.expressions.ListDefinitionExpression;
...
public class HlclUtil {
	...
	public static Set<Identifier> getUsedIdentifiers(IntExpression e) {

		Set<Identifier> ids = new TreeSet<Identifier>();

		if (e instanceof HlclProgram) {
			for (IntExpression exp : (HlclProgram) e)
	...
	public static Map<Identifier, Long> getCountOfIdentifiers(IntExpression e) {
