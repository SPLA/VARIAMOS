...
public class AndBooleanTransformation extends AbstractBooleanTransformation {
	...
	public AndBooleanTransformation(InstElement left, InstElement right,
	...
	public AndBooleanTransformation(InstElement vertex, String attributeName,
	 ...
	 * this.expressionConnectors.add(TRANSFORMATION); }
	 */
	public AndBooleanTransformation(AbstractTransformation leftSubExpression,
