 ...
 * @since 2014-12-14
 */
public class GreaterOrEqualsBooleanTransformation extends AbstractBooleanTransformation {
	private static final String TRANSFORMATION = "#>=";
	
	public GreaterOrEqualsBooleanTransformation(InstElement left, InstElement right, String leftAttributeName, String rightAttributeName) {
		super(left, right, leftAttributeName, rightAttributeName);
		this.expressionConnectors.add(TRANSFORMATION);
	}
	public GreaterOrEqualsBooleanTransformation(InstElement vertex,
	...
	public GreaterOrEqualsBooleanTransformation(
