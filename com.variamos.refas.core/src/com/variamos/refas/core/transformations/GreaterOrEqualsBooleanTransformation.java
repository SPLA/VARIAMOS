...
public class GreaterOrEqualsBooleanTransformation extends AbstractBooleanTransformation {
	...
	public GreaterOrEqualsBooleanTransformation(InstVertex left, InstVertex right, String leftAttributeName, String rightAttributeName) {
		super(left, right, leftAttributeName, rightAttributeName);
		this.expressionConnectors.add(TRANSFORMATION);
	}
	public GreaterOrEqualsBooleanTransformation(InstVertex vertex,
