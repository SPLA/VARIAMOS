...
public class Refas2Hlcl {
	...
	public Refas2Hlcl(Refas refas) {
		...
		// Previous edgeExpressions is required to fill the attribute names for
		// groupExpressions
	...
	private void createVertexExpressions(Refas refas, Map<String, Identifier> idMap) {
		for (InstVertex elm : refas.getVariabilityVertexCollection()) {
			...
			// if (elm instanceof InstConcept) { // TODO not required if the
			// method
			...
			// AbstractNumericTransformation transformation1 = new
			// DiffNumericTransformation(
			...
			// AbstractNumericTransformation transformation2 = new
			// DiffNumericTransformation(
			...
			// // A_Satisfied) #= 0
			// AbstractNumericTransformation transformation3 = new
			// DiffNumericTransformation(
			// elm, "Selected", false, f.number(1));
			// AbstractNumericTransformation transformation4 = new
			// SumNumericTransformation(
			// elm, elm, "SimRequired",
			// instAttribute.getIdentifier());
			...
			//
			// AbstractBooleanTransformation transformation5 = new
			// OrBooleanTransformation(
			// elm, elm, "ForcedSatisfied",
			// "AlternativeSatisfied");
			// AbstractBooleanTransformation transformation6 = new
			// AndBooleanTransformation(
			// elm, elm, "ValidationSatisfied",
			// "SimAllowed");
			// AbstractBooleanTransformation transformation7 = new
			// OrBooleanTransformation(
			...
			// // #\/ A_SimRequired )
			//
			// AbstractBooleanTransformation transformation8 = new
			// AndBooleanTransformation(
			// elm, elm, "SolverSelected",
			// "PreferredSelected");
			// AbstractBooleanTransformation transformation9 = new
			// OrBooleanTransformation(
			// elm, elm, "ValidationSelected",
			// "SimRequired");
			// AbstractBooleanTransformation transformation10 = new
			// OrBooleanTransformation(
	...
	private void createEdgeExpressions(Refas refas,
		...
		for (InstEdge elm : refas.getConstraintInstEdgesCollection()) {
			...
			// if (metaEdge != null
			// &&
			// elm.getInstAttribute(MetaDirectRelation.VAR_METADIRECTEDGETYPE)
			// != null
			...
			// AbstractBooleanTransformation transformation1 = new
			// AndBooleanTransformation(
			// elm.getFromRelation(), elm.getToRelation(),
			// "Satisfied", "Satisfied");
			// AbstractBooleanTransformation transformation2 = new
			// AndBooleanTransformation(
			// elm.getFromRelation(), "PreferredSelected", false,
			// transformation1);
			//
			// AbstractBooleanTransformation transformation3 = new
			// AssignBooleanTransformation(
			// elm.getToRelation(), "PreferredSelected",
			// f.number(1));
			// AbstractBooleanTransformation transformation4 = new
			// AssignBooleanTransformation(
			...
			// AbstractNumericTransformation transformation6 = new
			// DiffNumericTransformation(
			// elm.getFromRelation(), "Selected", false,
			// f.number(1));
			// AbstractNumericTransformation transformation7 = new
			// SumNumericTransformation(
			...
			// AbstractBooleanTransformation transformation10 = new
			// NotBooleanTransformation(
			// elm.getFromRelation(), "Satisfied");
			// AbstractBooleanTransformation transformation11 = new
			// AndBooleanTransformation(
			// elm.getToRelation(), "Satisfied", false,
			// transformation10);
			// AbstractBooleanTransformation transformation12 = new
			// AndBooleanTransformation(
			// elm.getFromRelation(), "Selected", false,
			// transformation11);
			// AbstractBooleanTransformation transformation13 = new
			// AssignBooleanTransformation(
			// elm.getFromRelation(), "AlternativeSatisfied",
			// f.number(1));
			// AbstractBooleanTransformation transformation14 = new
			// AssignBooleanTransformation(
			// elm.getToRelation(), "ValidationSelected",
			// f.number(1));
			// AbstractBooleanTransformation transformation15 = new
			// AndBooleanTransformation(
			...
			// AbstractBooleanTransformation transformation16 = new
			// AssignBooleanTransformation(
			...
			// AbstractBooleanTransformation transformation18 = new
			// AssignBooleanTransformation(
			// elm.getFromRelation(), "ValidationSelected",
			// f.number(1));
			// transformations.add(new ImplicationBooleanTransformation(
			...
			// AbstractBooleanTransformation transformation19 = new
			// AssignBooleanTransformation(
			// elm.getToRelation(), "ValidationSelected",
			// f.number(1));
			// transformations.add(new ImplicationBooleanTransformation(
			...
			// transformation19));
			// // B_Selected #==> A_ValidationSelected #=1
			// AbstractBooleanTransformation transformation20 = new
			// AssignBooleanTransformation(
			// elm.getFromRelation(), "ValidationSelected",
			// f.number(1));
			// transformations.add(new ImplicationBooleanTransformation(
			...
			// }
			// for (AbstractBooleanTransformation transformation :
			// transformations) {
			// idMap.putAll(transformation.getIndentifiers(f));
	...
	private void createGroupExpressions(Refas refas,
		...
		for (InstGroupDependency elm : refas
			...
			// &&
			// elm.getInstAttribute(SemanticGroupDependency.VAR_CARDINALITYTYPE)
			// != null) {
			...
			// recursiveExpression1 = transformation(constructor1,
			// constructor2, instEdges1, left1, sourceName);
			// AbstractTransformation transformation1 = new
			// EqualsComparisonTransformation(
			// recursiveExpression1,
			// new NumberNumericTransformation(1));
			// transformations
			// .add(new EqualsComparisonTransformation(
			...
			// recursiveExpression1 = transformation(constructor1,
			// constructor2, instEdges1, left1, sourceName);
			// AbstractTransformation transformation3 = new
			// GreaterOrEqualsBooleanTransformation(
			// elm,
			// "lowCardinality", false, recursiveExpression1);
			//
			// AbstractTransformation transformation4 = new
			// GreaterOrEqualsBooleanTransformation(
			// elm,
			// "highCardinality", false, recursiveExpression2);
			//
			// AbstractTransformation transformation5 = new
			// AndBooleanTransformation(
			// transformation3, transformation4);
			//
			// transformations
