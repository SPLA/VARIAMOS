...
import com.cfm.productline.configurator.treetable.actions.SetValueAction;
...
public class ConfigurationDataModel extends AbstractTreeTableModel{
	...
	//static protected String[] captions = { "Variable", "Step", "Choice", "Value", "Extra" };
	...
	public ConfigurationDataModel(Object root, Configurator configurator) {
		super(root);
		steps = 0;
	...
	public void setValueAt(Object aValue, Object node, int column) {
		...
		switch(column){
			case COLUMN_VALUE:
				...
				ConfigurationAction ca = newSetAction(n.getVariable(), (Integer)aValue);
