...
import com.cfm.productline.editor.ParameterFormDialog.DialogButtonAction;
import com.cfm.productline.type.IntegerType;
import com.cfm.productline.type.StringType;

@SuppressWarnings("serial")
public class AttributeListForm extends JList<Variable> {
	private ProductLineEditor editor;
	private VariabilityElement element;
	
	private Variable spoof = new Variable("Add ...", "Add ...", StringType.IDENTIFIER);
	
	public AttributeListForm(ProductLineEditor editor){
		this.editor = editor;
		init(null);
	}

	public AttributeListForm(ProductLineEditor editor, VariabilityElement elm) {
		this.editor = editor;
		this.element = elm;
	...
	protected void editItem(Variable var){
		...
		final ParameterFormDialog dialog = new ParameterFormDialog(editor, name, domain);
