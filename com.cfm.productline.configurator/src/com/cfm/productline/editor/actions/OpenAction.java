...
public class OpenAction extends ConfiguratorEditorAction{
	/**
	 * 
	 */
	...
	protected void openSXFM(BasicGraphEditor editor, File file) throws IOException, FeatureModelException{
		...
		((ProductLineEditor)editor).editProductLine(pl);
...
//										graph.getModel());
								...
								PLGReader.loadPLG(fc.getSelectedFile(), (ProductLineGraph) graph);
								editor.setCurrentFile(fc
										.getSelectedFile());
								
								((ProductLineEditor)editor).populateIndex(((ProductLineGraph)graph).getProductLine());
