...
import com.cfm.productline.editor.shapes.OptionalMarker;
...
public class ProductLineGraph extends mxGraph {
	...
	private void init() {
		...
		Document doc = mxUtils.loadDocument(ProductLineGraphComponent.class
				.getResource(
						"/com/cfm/productline/editor/style/styles.xml")
				.toString());
	...
	public void buildFromProductLine2(ProductLine pl, ProductLineIndex pli) {
