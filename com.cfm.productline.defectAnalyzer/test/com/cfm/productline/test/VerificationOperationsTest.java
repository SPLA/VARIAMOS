...
//				//Negacion ( Web_Portal #/\(1-Web_Server #>0)#\/ ( Web_Server #/\  (1-Web_Portal #>0)))
//				//Esta relación no es redundante
//				//String negationExpression="( Web_Portal #/\\(1-Web_Server #>0)#\\/ ( Web_Server #/\\  (1-Web_Portal #>0)))";
//				String negationExpression="( Web_Portal * (1-Web_Server)+ ( Web_Server * (1-Web_Portal)) #>0)";
//				Long dependencyNumber=7L;
//				Defect redundancy = verifier
//						.identifyRedundancy(negationExpression, variabilityModel.getDependencies().get(dependencyNumber));
//				
//				// Test Results
...
//
//		// Transform VariabilityModel
//		VariabilityModel variabilityModel = transformFeatureModel("test/testModels/Betty5Features_FeatureModel10.sxfm");
//
//		// Define Prolog editor type ( GNU or SWI)
//		SolverEditorType prologEditorType = SolverEditorType.SWI_PROLOG;
//
...
//		VariabilityModel variabilityModel = transformFeatureModel("test/testModels/Feature10ModelAllFormatsFeatureModelFeatureModel0.splx");
//
//		// Define Prolog editor type ( GNU or SWI)
...
//
//		String modelInputPath = "F:\\LINEASPRODUC_WORKSPACE\\com.cfm.productline.defectAnalyzer\\test\\testModels\\prologFiles\\GNU_PROLOGBetty5Features_FeatureModel3.pl";
//		SolverEditorType solverEditorType = SolverEditorType.GNU_PROLOG;
//
//		VariabilityModel variabilityModel = null;
//
...
//
//		// Transform VariabilityModel
//		String modelInputPath = "F:\\LINEASPRODUC_WORKSPACE\\com.cfm.productline.defectAnalyzer\\test\\testModels\\prologFiles\\GNU_PROLOGBetty5Features_FeatureModel4FalsePLM.pl";
//		VariabilityModel variabilityModel = null;
//
//		// Define Prolog editor type ( GNU or SWI)
//		SolverEditorType solverEditorType = SolverEditorType.GNU_PROLOG;
...
//
//		String modelInputPath = "F:\\LINEASPRODUC_WORKSPACE\\com.cfm.productline.defectAnalyzer\\test\\testModels\\prologFiles\\Car_9_fm.pl";
//		SolverEditorType solverEditorType = SolverEditorType.GNU_PROLOG;
//
//		VariabilityModel variabilityModel = null;
//
...
//
//		// Transform VariabilityModel
//		String modelInputPath = "F:\\LINEASPRODUC_WORKSPACE\\com.cfm.productline.defectAnalyzer\\test\\testModels\\prologFiles\\CellPhone_15_fm.pl";
//		SolverEditorType solverEditorType = SolverEditorType.GNU_PROLOG;
...
//		VariabilityModel variabilityModel = transformProductLine("test/testModels/Betty5Features_FeatureModel10.sxfm");
//
//		// Define Prolog editor type ( GNU or SWI)
//		SolverEditorType prologEditorType = SolverEditorType.GNU_PROLOG;
//
...
//
//		// Transform VariabilityModel
//		VariabilityModel variabilityModel = transformProductLine("test/testModels/Betty25Features_FeatureModel0.splx");
//
//		// Define Prolog editor type ( GNU or SWI)
//		SolverEditorType prologEditorType = SolverEditorType.GNU_PROLOG;
//
...
//		VariabilityModel variabilityModel = transformFeatureModel("test/testModels/Betty25Features_FeatureModel0.splx");
//
//		// Define Prolog editor type ( GNU or SWI)
//		SolverEditorType prologEditorType = SolverEditorType.GNU_PROLOG;
//
