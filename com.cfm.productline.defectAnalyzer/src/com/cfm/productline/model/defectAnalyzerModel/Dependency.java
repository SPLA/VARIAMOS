...
public class Dependency implements Cloneable {
	...
	// Eliminar
	private Hlcl2SWIProlog convertidor;

	public Dependency() {
		super();

		constraintExpression = null;
		convertidor = new Hlcl2SWIProlog();
	}
	...
	/**
	 * @return the prologInstruction
	 */
	private String getPrologInstruction(Expression expression) {

		return convertidor.transformExpressionToProlog(expression).toString();
	}
