...
import com.cfm.productline.model.defect.DeadElement;
import com.cfm.productline.model.defect.Defect;
import com.cfm.productline.model.defect.FalseOptionalElement;
import com.cfm.productline.model.defect.FalseProductLine;
...
import com.cfm.productline.model.defectAnalyzerModel.DefectAnalyzerDomain;
...
import com.cfm.productline.util.VerifierUtilExpression;
...
public class VariabilityModelVerifier extends VariabilityModelAnalyzer {
	...
	public Defect isVoid() throws FunctionalException {
		...
		boolean isVoid = !SolverOperationsUtil.isSatisfiable(prologTempPath,
				prologEditorType);
	...
	public Defect identifyRedundancy(String instructionToCheckRedundacy,
		...
		// Se evalua si el modelo de restricciones guardado en la
		// ruta temporal es resoluble
		isSatisfiable = SolverOperationsUtil.isSatisfiable(prologTempPath,
				prologEditorType);
